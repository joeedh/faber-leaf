 ...
 *
 * In-bundle builtins (today just `litemesh`) are intentionally compiled into
 * the main bundle and are NOT in `EXTERNAL_IDS`, so the guard never fires on
 * them.
 *
 ...
 * @type {Set<string>}
 */
export const IN_BUNDLE_BUILTIN_IDS = new Set(['litemesh'])
